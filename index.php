...
<head>
    ...
    <meta name="author" content="Anant Raj">
    <title>Gyaan Ganga Books</title>
    <!-- Bootstrap -->
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="img/logo1.jpg"  style="width: 118px;margin: 0px;"></a>
        </div>
...
?>
  ...
  <div id="top" >
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;background-color:grey">
          <div>
      ...
      <div class="container-fluid"  id="header">
          <div class="row" >
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#DC143C;color:#fff;font-weight:800;border:none;padding:15px;"> Categories </div>
                  <ul>
                  ...
                  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                          <div class="item active">
                            <img class="img-responsive" src="img/carousel/a.jpg">
                          </div>

                          <div class="item">
                            <img class="img-responsive "src="img/carousel/b.jpg">
                          </div>
                          ...
                          <div class="item">
                            <img class="img-responsive"src="img/carousel/c.jpg">
                          </div>
              ...
              <div class="col-md-3 col-lg-3" id="offer">
                  <a href="Product.php?value=Regional%20Books">              <img class="img-responsive center-block" src="img/offers/a.jpg"></a>
                  <a href="Product.php?value=Health%20and%20Cooking">        <img class="img-responsive center-block" src="img/offers/b.jpg"></a>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-5&category=new">
              <div class="book-block">
                  ...
                  <img class="book block-center img-responsive" src="img/new/a.jpg">
                  <hr>
                  Long Bright River <br>
                  Rs 113  &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 175 </span>
                  <span style="color: #DC143C" class="label label-warning">35%</span>
              </div>
            </a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-6&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/new/b.jpg">
                  <hr>
                  Mr. Nobody: A Novel  <br>
                  Rs 600 &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 750 </span>
                  <span style="color: #DC143C" class="label label-warning">20%</span>
              </div>
            </a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-7&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/new/c.jpg">
                  <hr>
                  If I Had Your Face <br>
                  Rs 800 &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 1000 </span>
                  <span style="color: #DC143C" class="label label-warning">20%</span>
              </div>
            </a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-8&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/new/d.jpg">
                  <hr>
                  Offerings <br>
                  Rs 1200 &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 2000 </span>
                  <span style="color: #DC143C" class="label label-warning">40%</span>
              </div>
            </a>
          </div>
      </div>
  ...
  <div class="container-fluid" style ="background-image: url('img/bg.jpg') " id="author">
      <h2 style="color:	#DC143C;"> Trending </h2>
      <div class="row">
          <div class="col-sm-5 col-md-3 col-lg-3">
              <a href="Author.php?value=Durjoy%20Datta"><img class="img-responsive center-block" src="img/popular-author/a.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Chetan%20Bhagat"><img class="img-responsive center-block" src="img/popular-author/b.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Dan%20Brown"><img class="img-responsive center-block" src="img/popular-author/c.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Ravinder%20Singh"><img class="img-responsive center-block" src="img/popular-author/d.jpg"></a>
          </div>
      </div>
      <div class="row">
          <div class="col-sm-5 col-md-3 col-lg-3">
              <a href="Author.php?value=Jeffrey%20Archer"><img class="img-responsive center-block" src="img/popular-author/e.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Salman%20Rushdie"><img class="img-responsive center-block" src="img/popular-author/f.jpg"><a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=J%20K%20Rowling"><img class="img-responsive center-block" src="img/popular-author/g.jpg"></a>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3">
              <a href="Author.php?value=Subrata%20Roy"><img class="img-responsive center-block" src="img/popular-author/h.jpg"></a>
          </div>
      </div>
  </div>
          ...
          <div class="row">
              ...
              <div class="col-sm-7 col-md-5 col-lg-5">
                  <div class="row text-center">
                      <h2 style="color:	#DC143C;">Contact us</h2>
                      <hr class="primary">
                      <p style="color:	#DC143C;">Still Confused? Give us a call or send us an email and we will get back to you as soon as possible!</p>
                  </div>
                  <div class="row">
                      <div class="col-md-6 text-center">
                          <span class="glyphicon glyphicon-earphone"></span>
                          <p style="color:	#DC143C;">093048 26655</p>
                      </div>
                      <div class="col-md-6 text-center">
                          <span class="glyphicon glyphicon-envelope"></span>
                          <p style="color:	#DC143C;">gyanganga@gmail.com</p>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  <h2 style="color:	#DC143C;">Follow Us At</h2>
                  <div>
...
<div class="container">
  ...
  <button type="button" id="query_button" class="btn btn-lg" data-toggle="modal" data-target="#query" style="color:	#DC143C;">Ask query</button>
  <!-- Modal -->
